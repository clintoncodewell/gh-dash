...
- Display the preview pane on the right at 57.5% width, including on narrow terminals.
...
By default, the preview pane is 57.5% wide.
...
By default, the preview pane height is 60%.

#### Preview Pane Position (`position`)

| Type   |          Options          | Default |
| :----- | :-----------------------: | :-----: |
| String | `right`, `bottom`, `auto` | `right` |
...
By default, the position is `right`.
