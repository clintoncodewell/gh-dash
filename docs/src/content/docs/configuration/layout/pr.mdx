...
1. [`lines`] with a width of 3 columns.
...
| Property | Type | Default                                            |
| :------- | :--- | :------------------------------------------------- |
| `lines`  | yaml | <Code code={`width: 3`} lang="yaml" frame="none"/> |

This column displays whether the PR changes code. A green change icon means
additions or deletions are present; a faint empty icon means no code lines changed.
