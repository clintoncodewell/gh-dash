...
<Aside type="caution" title="Watch out!">
  Even though the `state`, `title`, and `comments` settings
  aren't explicitly defined in your configuration file, they're added to
  the table unless you set their [`hidden`] option to `true`.
...
## Issue Created At Column

| Property    | Type | Default                                                          |
| :---------- | :--- | :--------------------------------------------------------------- |
| `createdAt` | yaml | <Code code={`width: 5\nhidden: true`} lang="yaml" frame="none"/> |

This optional column displays how long ago the issue was created. Creation time
also remains visible in the ticket detail pane.
...
unless you set [`hidden`] to `true`. By default, it grows to fill the available space
...
| Property  | Type | Default                                                           |
| :-------- | :--- | :---------------------------------------------------------------- |
| `creator` | yaml | <Code code={`width: 10\nhidden: true`} lang="yaml" frame="none"/> |
...
| Property    | Type | Default                                                          |
| :---------- | :--- | :--------------------------------------------------------------- |
| `reactions` | yaml | <Code code={`width: 3\nhidden: true`} lang="yaml" frame="none"/> |
